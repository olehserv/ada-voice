...
The single source of live status (including current test counts) is
**[handoff.md](handoff.md)** — read it first. Open work: responsive Full/Docked layout,
localization, installer; and the monetization build (`server/`, design in
[docs/monetize/](docs/monetize/README.md)) — Phases 0–2 shipped (schema, auth API), Phase 3 next.
...
└── docs/
    ...
    ├── reviews/           dated whole-codebase reviews (point-in-time)
